// app/editar/campeonato/[id]/page.tsx
"use client";
...
const campeonatosMock: Record<string, CampeonatoForm> = {
  "1": {
    ...
    formato: "Mata-mata",
    quantidadeTimes: "16",
    local: "Estádio Municipal, São Paulo - SP",
    logotipo: null,
  },
  "2": {
...
export default function EditarCampeonatoPage() {
  ...
  // Busca os dados pelo id — substituir por fetch do Supabase
  const dadosIniciais = campeonatosMock[id] ?? {
    nome: "",
    descricao: "",
    status: "Pendente" as Status,
    dataInicio: "",
    dataFim: "",
    formato: "Mata-mata" as Formato,
    quantidadeTimes: "",
    local: "",
    logotipo: null,
  };

  const [form, setForm] = useState<CampeonatoForm>(dadosIniciais);
  ...
  function handleSubmit() {
    ...
    // TODO: integrar com Supabase — update pelo id
    console.log("Atualizar campeonato id:", id, form);
